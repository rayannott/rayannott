...
| Oct 2022 - July 2025 | Technical University of Munich | ${\color{LimeGreen}\text{MSc}}$ Computational Science and Engineering (Informatics) | [tum.de](https://www.tum.de/en/) [wiki](https://en.wikipedia.org/wiki/Technical_University_of_Munich) |
...
|Apr 2024 - May 2025|Software Developer|_freelance_| Developed a telegram bot for a local business (see [here](https://github.com/rayannott/wizard-club-bot) if I ever take it public). Set everything up from scratch: telegram api, database **ORM**, **logging**, google sheets api, etc. |
